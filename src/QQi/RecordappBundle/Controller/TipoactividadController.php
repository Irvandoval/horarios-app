...
use QQi\RecordappBundle\Form\TipoactividadType;
...
class TipoactividadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('QQiRecordappBundle:Tipoactividad')->findAll();

        return $this->render('QQiRecordappBundle:Tipoactividad:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('QQiRecordappBundle:Tipoactividad')->find($id);
        ...
        return $this->render('QQiRecordappBundle:Tipoactividad:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        $form   = $this->createForm(new TipoactividadType(), $entity);

        return $this->render('QQiRecordappBundle:Tipoactividad:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new TipoactividadType(), $entity);
        $deleteForm = $this->createDeleteForm($id);

        return $this->render('QQiRecordappBundle:Tipoactividad:edit.html.twig', array(
            'entity'      => $entity,
