...
use QQi\RecordappBundle\Form\DiaType;
...
class DiaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('QQiRecordappBundle:Dia')->findAll();

        return $this->render('QQiRecordappBundle:Dia:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('QQiRecordappBundle:Dia')->find($id);
        ...
        return $this->render('QQiRecordappBundle:Dia:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('QQiRecordappBundle:Dia:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('QQiRecordappBundle:Dia:edit.html.twig', array(
            'entity'      => $entity,
